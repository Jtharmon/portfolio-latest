...
function EditPost() {
  ...
  const fetchPost = async () => {
    try {
      ...
      const { blog_secret, ...postData } = response.data;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Please authenticate to edit this post.</p>
          <button
            ...
            <div className="card p-6 bg-white/80 backdrop-blur-sm border-0 shadow-xl">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">Required to update or delete this post</p>
                </div>
